#!/usr/bin/env python3
"""
Nanjing BAMS150 re-label experiment
-----------------------------------
Uses updated data2/Nanjing/04_manual/Nanjing_BAMS150_Manual.csv
...
Outputs -> data2/nanjing_relabel_bams_pe/
"""
...
DATA2 = ROOT / "data2"
OUT_DIR = DATA2 / "nanjing_relabel_bams_pe"
...
def load_city() -> dict:
    ...
    print(
        f"Nanjing relabel: n_changed_vs_bk={n_changed}; "
        f"conf={conf_counts}; "
...
def parse_args():
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory (default: data2/nanjing_relabel_bams_pe)",
    )
    return p.parse_args()
